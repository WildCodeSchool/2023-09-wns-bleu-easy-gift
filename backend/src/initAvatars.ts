...
export default async function initAvatars() {
    ...
    const fantasy = Avatar.create({
        name: 'Avatar caricature kawaii de nounours rose',
        type: 'profil',
    ...
    const cat2 = Avatar.create({
        name: 'Avatar caricature kawaii de chat noir timide',
        type: 'profil',
        url: 'https://ucarecdn.com/f74f7d0e-a540-4eb3-9564-7a5c080536ca/-/preview/1000x1000/',
    })

    const generic1 = Avatar.create({
        name: 'Avatar de groupe dessin sur fond blanc avec cadeaux mutlicolor à rubans',
        type: 'generic',
    ...
    const generic3 = Avatar.create({
        name: 'Avatar de groupe avec cadeau pailleté bleu et ruban violine et doré',
        type: 'generic',
        url: 'https://ucarecdn.com/df1cf50f-0cff-415b-80e5-2e34884076c7/-/preview/1000x1000/',
    })

    const generic4 = Avatar.create({
        name: 'Avatar de groupe avec cadeau pailleté multicolore et ruban rouge',
        type: 'generic',
        url: 'https://ucarecdn.com/c7ea3dbe-f1af-473e-ba62-f348b267adb8/-/preview/1000x1000/',
    })

    const generic5 = Avatar.create({
        name: 'Avatar de groupe avec cadeau pailleté doré et rose et ruban violet',
        type: 'generic',
    ...
    const generic8 = Avatar.create({
        name: 'Avatar de groupe avec cadeau pailleté bleu et jaune et ruban rouge',
        type: 'generic',
