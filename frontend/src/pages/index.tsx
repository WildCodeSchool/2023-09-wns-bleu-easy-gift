                ...
                {(!isConnected ||
                    (isConnected && groups && groups?.length < 1)) && (
                        ...
                        <div className='flex flex-wrap gap-6 justify-center max-w-80 lg:justify-evenly w-10/12 md:max-w-2xl lg:w-full lg:max-w-full'>
                            ...
                            <div className='flex flex-wrap gap-6 justify-center max-w-80 lg:justify-center w-10/12 md:max-w-none md:min-w-[680px]  md:w-4/5lg:max-w-full lg:w-11/12 xl:max-w-[1200px]'>
