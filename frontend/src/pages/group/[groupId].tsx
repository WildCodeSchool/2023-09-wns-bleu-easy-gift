        ...
        <div className="flex flex-col gap-3 justify-between mx-auto w-10/12 md:max-w-2xl lg:max-w-4xl xl:max-w-[1100px]">
          ...
          <div className="bg-white flex flex-col gap-10 p-8 sm:rounded-xl shadow-2xl">
            <div className="flex flex-col gap-8 items-center sm:items-start sm:flex-row sm:gap-16 sm:justify-between">
              <div className="shrink sm:w-1/2 sm:max-w-lg">
                <div>
                  <div className="text-2xl font-medium">Informations du groupe</div>
                  <div className="text-sm text-black/60">Voici les informations de votre groupe</div>
                </div>
              </div>
              <div className="shrink sm:w-1/2 sm:max-w-lg">
                <div className="grid-cols-2">
                  ...
                  <div className="flex sm:justify-end">
                    <Button className="bg-blue-500 text-white px-4 py-2 rounded mt-10" onClick={() => setShowModal(true)}>
          ...
          <div className="bg-white flex flex-col gap-10 p-8 sm:rounded-xl shadow-2xl">
            <div className="flex flex-col gap-8 items-center sm:items-start sm:flex-row sm:gap-16 sm:justify-between">
              <div className="shrink sm:w-1/2 sm:max-w-lg">
                <div>
                  <div className="text-2xl font-medium">Membres du groups</div>
                  <div className="text-sm text-black/60">Voici la liste des membres de votre groupe</div>
                </div>
              </div>
              <div className="flex flex-col gap-3 shrink items-center sm:w-1/2 sm:max-w-lg">
                {group?.userToGroups.map((userToGroup) => {
                  return <ProfileCard key={userToGroup.user_id} userToGroup={userToGroup} />;
                })}
              </div>
            </div>
          </div>
